# Loan Accounts Module

The post-disbursement lifecycle of a loan — EMI schedule, foreclosure, and closure. The anchor that future Top-Up and Balance Transfer applications reference.
