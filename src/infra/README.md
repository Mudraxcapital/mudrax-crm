...
App-wide infrastructure wiring - stateful connections to the outside world that exist exactly once per running process (one DB pool, one auth config, one logger, one real-time gateway).
